...
../../bin/mosesserver -v 1 -f moses.0.s.ini --server-port 8080 -drop-unknown &> log.0.s &
static_server_0_pid=${!}
...
../../bin/mosesserver -v 1 -f moses.1.s.ini --server-port 8081 -drop-unknown &> log.1.s &
static_server_1_pid=${!}
...
../../bin/mosesserver -v 1 -f moses.0.d.ini --server-port 8090 -drop-unknown &> log.0.d &
...
../../bin/mosesserver -v 1 -f moses.1.d.ini --server-port 8091 -drop-unknown &> log.1.d &
...
2>&1 echo
./client.py -l0 0 -l1 1 -i0 input.0.txt -i1 input.1.txt -s0 8080 -s1 8081 -d0 8090 -d1 8091
